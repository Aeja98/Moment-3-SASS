...
- [x] Undersidan SASS ska innehålla en utvärdering av ditt arbete med SASS. Vilka för- och nackdelar ser du med SASS? Hur var det att komma igång att arbete med en CSS-preprocessor?
...
- [x] Responsiv webbdesign, både på innehåll och meny. Ska fungera väl på stora och små enheter.
...
- [x] Nesting
- [x] Mixins
- [x] Selector inheritance (nyckelordet "@extend").
- [x] If/else-satser.
- [x] Minst en partial
